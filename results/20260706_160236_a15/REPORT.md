...
- 2026-06-22 EURGBP price_out: desvio 21.4bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 2.7bp
- 2026-06-22 GBPAUD price_out: desvio 26.7bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 3.3bp
- 2026-06-22 GBPCAD price_out: desvio 26.7bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 1.8bp
- 2026-06-22 GBPCHF price_out: desvio 17.0bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 3.5bp
- 2026-06-22 GBPJPY price_out: desvio 31.4bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 1.3bp
- 2026-06-22 GBPNZD price_out: desvio 22.5bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 3.0bp
- 2026-06-22 GBPUSD price_out: desvio 34.1bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 0.9bp
- 2026-06-23 AUDCHF price_out: desvio 19.9bp (M5@-0min) | diagnóstico: melhor offset de relógio -2h → 1.2bp
- 2026-06-23 EURAUD price_out: desvio 20.9bp (M5@-1min) | diagnóstico: melhor offset de relógio +3h → 2.5bp
- 2026-06-24 AUDJPY price_out: desvio 18.5bp (M5@-1min) | diagnóstico: melhor offset de relógio +5h → 2.3bp
- 2026-06-24 GBPJPY price_out: desvio 26.3bp (M5@-2min) | diagnóstico: melhor offset de relógio +3h → 0.5bp
- 2026-06-24 NZDJPY price_out: desvio 30.6bp (M5@-2min) | diagnóstico: melhor offset de relógio +5h → 1.0bp
- 2026-06-25 EURCAD price_out: desvio 15.5bp (M5@+2min) | diagnóstico: melhor offset de relógio +5h → 1.5bp
- 2026-06-25 EURJPY price_out: desvio 21.0bp (M5@+2min) | diagnóstico: melhor offset de relógio +3h → 2.2bp
- 2026-06-25 EURUSD price_out: desvio 29.3bp (M5@+2min) | diagnóstico: melhor offset de relógio +3h → 1.8bp
