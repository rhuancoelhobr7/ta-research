# a13 — Peso (derivada do CSS) em T0 → sinal Tokyo→NY (pares: all28, janela: 15h)
...
Dias: 395 | acaso pareado: **50.0%** | reality check p95: **56.5%**

| regra | n | top-1 | bate baselines? | > p95? |
|---|---|---|---|---|
| RA_exaustao_contra | 343 | 53.9% | SIM | não |
| RB_transferencia_H4 | 177 | 49.7% | não | não |
| RC_amparo_D1 | 51 (n<100!) | 45.1% | não | não |
...
- logistic: AUC **0.512** ± 0.015 (5 folds)
- gboost: AUC **0.510** ± 0.022 (5 folds)
